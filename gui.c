...
int init_gui()
{
    ...
    infoBlock = getRectangleShape(getVector(590, 72), getVector(600, 40), sfColor_fromRGBA(70, 70, 70, 80), sfBlack, 2.0);

    stackframeBox1 = getRectangleShape(getVector(590, 100), getVector(600, 120), sfColor_fromRGBA(255, 243, 82, 240), sfBlack, 2.0);

    stackframeBox2 = getRectangleShape(getVector(590, 100), getVector(600, 220), sfColor_fromRGBA(253, 203, 78, 240), sfBlack, 2.0);

    stackframeBox3 = getRectangleShape(getVector(590, 100), getVector(600, 320), sfColor_fromRGBA(251, 163, 75, 240), sfBlack, 2.0);

    stackframeBox4 = getRectangleShape(getVector(590, 100), getVector(600, 420), sfColor_fromRGBA(249, 123, 71, 240), sfBlack, 2.0);

    stackframeBox5 = getRectangleShape(getVector(590, 100), getVector(600, 520), sfColor_fromRGBA( 248, 83, 68, 240), sfBlack, 2.0);



	//creat Indicator
	indicator = sfCircleShape_create();
	sfCircleShape_setRadius(indicator, 5.5);
	sfCircleShape_setFillColor(indicator,sfRed);
...
int refresh_gui(struct ParseState *Parser){
	...
	if(window){	
		...
		indicator_pos = lineNumbersPos;
		indicator_pos.x -= 15; 
		indicator_pos.y +=  3;		
		indicator_pos.y += 15.0 *( getLine(Parser) - 1 ); 
		
		sfCircleShape_setPosition(indicator,indicator_pos);
	
refresh:

		
		// Clear the screen
		if(window)sfRenderWindow_clear(window, sfWhite); //sfColor_fromRGBA(49, 60, 72, 1.0));
		...
		sfRenderWindow_drawCircleShape(window, indicator, NULL);
		//draw Texts
